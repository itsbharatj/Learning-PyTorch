## Implementing Linear Regression using Optimizer Module and Custome Model for forward pass from PyTorch : 
import numpy as np
import torch
...
class LinearModel(torch.nn.Module): 
    ...
    def __init__(self, input_dim, output_dim): 
        ...
        ##This inherits from the Linear Model class of PyTorch: 
